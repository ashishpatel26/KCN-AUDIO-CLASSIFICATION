...
model.add(Conv1D(32,17,input_shape=(sampleSize,1), strides=4,padding="same"))
model.add(Activation("relu"))
model.add(Conv1D(32,17,padding="same",strides=4))
model.add(Activation("relu"))
model.add(MaxPool1D(4))
model.add(Conv1D(64,15, strides=2,padding="same"))
model.add(Activation("relu"))
model.add(Conv1D(64,15,padding="same",strides=4))
model.add(Dropout(.2))
model.add(Conv1D(64,11,padding="same",strides=4))
model.add(Activation("relu"))
model.add(Conv1D(128,11,padding="same",strides=4))
model.add(Activation("relu"))
